    ...
    override func draw(_ rect:CGRect) -> Void {
        ...
        func addAnimations() -> Void {
            ...
            while changeRadius < standardRadius {
                ...
                aLayer.add(getKeyframeAnimationWithPath(path: path, reverses: reverses), forKey: "PostionKeyframeValueAni")
        ...
        drawRoundWithContextRef(ctx: ctx!)
        addAnimations()
